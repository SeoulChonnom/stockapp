...
async def test_list_active_keywords_filters_by_provider_market_and_active_flag():
                ...
                [
                    {
                        ...
                        "is_active": True,
                        "priority": 10,
                        "created_at": datetime(2026, 3, 18, 6, 0, tzinfo=timezone.utc),
                        "updated_at": datetime(2026, 3, 18, 6, 0, tzinfo=timezone.utc),
                    }
                ]
            )
        ]
    ...
    result = await repo.list_active_keywords(provider_name="NAVER_NEWS", market_type="US")
                ...
                [
                    {
                        ...
                        "updated_at": datetime(2026, 3, 19, 0, 0, tzinfo=timezone.utc),
                    }
                ]
            )
        ]
                ...
                [
                    {
                        ...
                        "priority": 30,
                        "created_at": datetime(2026, 3, 19, 0, 0, tzinfo=timezone.utc),
                        "updated_at": datetime(2026, 3, 19, 1, 0, tzinfo=timezone.utc),
                    }
                ]
            )
        ]
