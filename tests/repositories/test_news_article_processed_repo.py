...
NewsArticleRawProcessedMapCreateParams = projections_module.NewsArticleRawProcessedMapCreateParams
...
async def test_link_raw_to_processed_uses_on_conflict_do_nothing():
    ...
    await repo.link_raw_to_processed(
        NewsArticleRawProcessedMapCreateParams(raw_article_id=1, processed_article_id=4001)
    )
