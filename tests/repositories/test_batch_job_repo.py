                ...
                [
                    {
                        ...
                        "error_message": None,
                        "log_summary": None,
                        "created_at": datetime(2026, 3, 18, 6, 10, tzinfo=timezone.utc),
                        "updated_at": datetime(2026, 3, 18, 6, 10, tzinfo=timezone.utc),
                    }
                ]
            )
        ]
                ...
                [
                    {
                        ...
                        "status": "SUCCESS",
                        "started_at": datetime(2026, 3, 18, 6, 10, tzinfo=timezone.utc),
                        "ended_at": datetime(2026, 3, 18, 6, 12, tzinfo=timezone.utc),
                ...
                [
                    {
                        ...
                        "rebuild_page_only": False,
                        "started_at": datetime(2026, 3, 18, 6, 10, tzinfo=timezone.utc),
                        "ended_at": datetime(2026, 3, 18, 6, 12, 15, tzinfo=timezone.utc),
                        "duration_seconds": 135,
                        "market_scope": "GLOBAL",
                        "raw_news_count": 174,
                        "processed_news_count": 114,
                        ...
                        "created_at": datetime(2026, 3, 18, 6, 10, tzinfo=timezone.utc),
                        "updated_at": datetime(2026, 3, 18, 6, 12, 15, tzinfo=timezone.utc),
                    }
                ]
            )
        ]
