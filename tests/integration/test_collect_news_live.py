...
async def _resolve_live_business_date(
    provider: NaverNewsProvider, query: str
) -> datetime:
    ...
    raise AssertionError(
        'Naver news API returned no parsable items for the integration keyword.'
    )
...
async def test_collect_news_step_collects_live_naver_articles(
