...
class EventRecorder:
    ...
    async def add_event(self, *, job_id: int, step_code: str, level: str, message: str, **kwargs):
        _ = (job_id, kwargs)
...
async def test_remaining_batch_steps_emit_lifecycle_events_and_preserve_context(step_cls, expected_message):
