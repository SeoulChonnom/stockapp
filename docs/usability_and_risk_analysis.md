...
| 3-11 health/readiness 부재 | 구현됨 | `/stock/api/health`는 인증 없는 liveness, `/stock/api/ready`는 DB `SELECT 1` readiness와 503 에러 봉투를 제공한다. | `app/api/health.py`, `app/api/router.py`; `tests/api/test_health.py` |
